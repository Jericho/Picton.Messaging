...
In December 2017 version 1.2 was released with a dedicated task to fetch messages from the Azure queue instead of allowing each individual concurent task to fetch their own messages.
